...
@interface ZTShuiShouController ()
...
@implementation ZTShuiShouController
...
//            [self.resultSection addItem:[WBSubtitleItem itemWithTitle:@"123" fontSzie:12]];
//            [self.resultSection addItem:[WBSubtitleItem itemWithTitle:@"456" fontSzie:12]];
//            [self.resultSection addItem:[WBSubtitleItem itemWithTitle:@"789" fontSzie:12]];
        
            
            // 应缴税款
            NSString *taxPayble = [NSString stringWithFormat:@"%.3f",weakSelf.taxPayable];
            [self.resultSection addItem:[WBSubtitleItem itemWithTitle:@"应缴税款:" rightSubtitle:[self changeFloat:taxPayble]]];
            
            // 税后收入
            NSString *afterTax = [NSString stringWithFormat:@"%.3f",weakSelf.afterTax];
            [self.resultSection addItem:[WBSubtitleItem itemWithTitle:@"税后收入:" rightSubtitle:[self changeFloat:afterTax]]];
...
-(void)dealloc
{
    NSLog(@"RevenueController dealloc");
}
