...
@property (nonatomic, assign) float  widthV;
...
- (void)viewDidLoad
{
    ...
    float margin = 15;
    float height = 47;
    CGFloat widthV = (self.view.frame.size.width - 20) / 3 ;
    self.widthV = widthV;
    ...
    userContentView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
    userContentView.contentSize = CGSizeMake(self.view.frame.size.width, self.view.frame.size.height * 0.6);
    ...
    shangDaiBtn.frame = CGRectMake(left, margin, widthV, height);
    ...
    gongBtn.frame = CGRectMake(widthV+left, margin, widthV , height);
    ...
    zuHeBtn.frame = CGRectMake(widthV * 2 + left, margin, widthV , height);
    ...
    //添加还款类型页面
    UIImageView * topImgView = [[UIImageView alloc]initWithFrame:CGRectMake(10, margin + height, self.widthV * 3, hkfs)];
    ...
    oneBtn.frame = CGRectMake(widthV, circleMargin, circle, circle);
    ...
    twoBtn.frame = CGRectMake(widthV * 2 , circleMargin, circle, circle);
...
-(void)creatPopView
{
    ...
    //显示视图
    popIMgview = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.widthV * 3, 288)];
    ...
    //添加列表
    popTableView = [[UITableView alloc] initWithFrame:CGRectMake(2, 41, self.widthV * 3 - 10, 198) style:UITableViewStylePlain];
    ...
    //标题栏
    popLabel = [[UILabel alloc]initWithFrame:CGRectMake(7, 5, self.widthV * 3, 30)];
    ...
    quxiaoBtn.frame = CGRectMake(0, 240, self.widthV*3/2 , 43);
    ...
    quedingBtn.frame = CGRectMake(self.widthV*3/2, 240, self.widthV*3/2, 43);
...
-(void)addShangyeView
{
    ...
    float shangdaiViewY = 15 + 47 + 60;
    float shangdaiViewW = self.view.frame.size.width - 20;
    float imageH = 45;
    
    shangDaiView = [[UIView alloc]init];
    shangDaiView.hidden = YES;
    shangDaiView.frame = CGRectMake(10,shangdaiViewY, shangdaiViewW,self.view.frame.size.height - shangdaiViewY);
    
    shangDaiView.backgroundColor = [UIColor clearColor];
    
    //添加房款计价方式
    UIImageView * twoImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, shangdaiViewW, imageH)];
    ...
    shangDanBtn.frame = CGRectMake(widthV, 12, circleH, circleH);
    ...
    shangZongBtn.frame = CGRectMake(widthV*2, 12, circleH, circleH);
    ...
    //单价计算详细页面
    sonShangView_one = [[UIView alloc]initWithFrame:CGRectMake(0, 45, shangdaiViewW, 368)];
    sonShangView_one.backgroundColor = [UIColor clearColor];
    sonShangView_one.hidden = YES;
    [shangDaiView addSubview:sonShangView_one];

    UIImageView * oneImgView_shang = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, shangdaiViewW, 268)];
    ...
    CGFloat x = (self.view.frame.size.width - 200 - 20)/2;
    CGFloat w = 200;
    CGFloat h = 45;
    ...
    shangOneBtn.frame = CGRectMake(x, 288, w, h);
    ...
    //添加输入部分信息
        //单价部分
    UIImageView * inputImg_dan_one = [[UIImageView alloc]initWithFrame:CGRectMake(widthV, 7, 92, 30)];
    ...
    [inputImg_dan_one addSubview:shangJiaGe];
        ...
        //面积部分
    UIImageView * inputImg_dan_two = [[UIImageView alloc]initWithFrame:CGRectMake(widthV, 52, 92, 30)];
    ...
    btnOne.frame = CGRectMake(widthV, 97, 167, 30);
    btnOne.tag = 1;
    ...
    btnTwo.frame = CGRectMake(widthV, 142, 167, 30);
    btnTwo.tag = 2;
    ...
    btnTre.frame = CGRectMake(widthV, 187, 167, 30);
    btnTre.tag = 3;
    ...
    [btnTre addSubview:shangDanLiLv];
        ...
        //显示利率
    label_1 = [[UILabel alloc]initWithFrame:CGRectMake(widthV, 230, 167, 25)];
    ...
    //总价计算详细页面
    sonShangView_two = [[UIView alloc]initWithFrame:CGRectMake(0, 44, self.view.frame.size.width -20, 288)];
    sonShangView_two.backgroundColor = [UIColor clearColor];
    sonShangView_two.hidden = YES;
    [shangDaiView addSubview:sonShangView_two];

    UIImageView * twoImgView_shang = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width -20, 188)];
    ...
    //贷款总额输入部分
    UIImageView * inputImg_zong = [[UIImageView alloc]initWithFrame:CGRectMake(widthV, 8, 92, 30)];
    ...
    btnOne_one.frame = CGRectMake(widthV, 52, 167, 30);
    btnOne_one.tag = 4;
    ...
    btnOne_two.frame = CGRectMake(widthV, 96, 167, 30);
    btnOne_two.tag = 5;
    ...
    //显示利率
    label_2 = [[UILabel alloc]initWithFrame:CGRectMake(widthV, 137, 167, 25)];
    ...
    shangTwoBtn.frame = CGRectMake(x, 288, w, h);
    [shangTwoBtn setBackgroundImage:[UIImage imageNamed:@"button_js.png"] forState:UIControlStateNormal];
...
-(void)addGongjiView
{
    ...
    gongView.hidden = YES;
    gongView.frame = CGRectMake(10, 62+59, self.view.frame.size.width -20, 500);
    gongView.backgroundColor = [UIColor clearColor];
    //添加房款计价方式
    UIImageView * twoImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width -20, 45)];
    twoImgView.image = [UIImage imageNamed:@"top_02.png"];
    twoImgView.userInteractionEnabled = YES;
    ...
    gongDanBtn.frame = CGRectMake(widthV, 12, circleH, circleH);
    ...
    gongZongBtn.frame = CGRectMake(widthV*2, 12, circleH, circleH);
    ...
    //单价计算详细页面
    sonGongView_one = [[UIView alloc]initWithFrame:CGRectMake(0, 45, self.view.frame.size.width -20, 368)];
    sonGongView_one.backgroundColor = [UIColor clearColor];
    sonGongView_one.hidden = YES;
    [gongView addSubview:sonGongView_one];

    UIImageView * oneImgView_shang = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width -20, 268)];
    oneImgView_shang.userInteractionEnabled = YES;
    oneImgView_shang.image = [UIImage imageNamed:@"danview.png"];
    ...
    //添加输入部分信息
    //单价部分
    UIImageView * inputImg_zong_one = [[UIImageView alloc]initWithFrame:CGRectMake(widthV, 7, 92, 30)];
    ...
    //面积部分
    UIImageView * inputImg_zong_two = [[UIImageView alloc]initWithFrame:CGRectMake(widthV, 52, 92, 30)];
    ...
    //显示利率
    label_3 = [[UILabel alloc]initWithFrame:CGRectMake(widthV, 230, 167, 25)];
    ...
    //总价计算详细页面
    sonGongView_two = [[UIView alloc]initWithFrame:CGRectMake(0, 44, self.view.frame.size.width -20, 288)];
    ...
    //显示利率
    label_4 = [[UILabel alloc]initWithFrame:CGRectMake(widthV, 137, 167, 25)];
    ...
    //添加按钮
    UIButton * shangTwoBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    shangTwoBtn.frame = CGRectMake(x, 208, w, h);
...
-(void)addZuheView
{
    ...
    //添加组合贷款页面
    UIImageView * zuHeImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width -20, 259)];
    ...
    //公积金贷款输入部分
    UIImageView * inputImg_zong_one = [[UIImageView alloc]initWithFrame:CGRectMake(widthV, 8, 92, 30)];
    inputImg_zong_one.userInteractionEnabled = YES;
    inputImg_zong_one.image = [UIImage imageNamed:@"input.png"];
    ...
    [inputImg_zong_two addSubview:shangDai];
       ...
       //按揭年数
    UIButton * btnOne_one = [UIButton buttonWithType:UIButtonTypeCustom];
    btnOne_one.frame = CGRectMake(widthV, 98, 167, 30);
    btnOne_one.tag = 11;
    [btnOne_one setImage:[UIImage imageNamed:@"selectlabel.png"] forState:UIControlStateNormal];
    [btnOne_one addTarget:self action:@selector(chooseAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [btnOne_one addSubview:zuHeNian];
       ...
       //利率
    UIButton * btnOne_two = [UIButton buttonWithType:UIButtonTypeCustom];
    btnOne_two.frame = CGRectMake(widthV, 142, 167, 30);
    btnOne_two.tag = 12;
    [btnOne_two setImage:[UIImage imageNamed:@"selectlabel.png"] forState:UIControlStateNormal];
    [btnOne_two addTarget:self action:@selector(chooseAction:) forControlEvents:UIControlEventTouchUpInside];
    ...
    //显示利率
    label_5 = [[UILabel alloc]initWithFrame:CGRectMake(widthV, 180, 167, 25)];
    ...
    label_6 = [[UILabel alloc]initWithFrame:CGRectMake(widthV, 215, 167, 25)];
    ...
    CGFloat w = 200;
    CGFloat h = 45;
    shangTwoBtn.frame = CGRectMake(x, 279, w, h);
    [shangTwoBtn setImage:[UIImage imageNamed:@"button_js.png"] forState:UIControlStateNormal];
    [shangTwoBtn addTarget:self action:@selector(jiSuanAction:) forControlEvents:UIControlEventTouchUpInside];
